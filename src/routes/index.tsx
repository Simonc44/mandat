  ...
  return (
    <div>
      ...
      <section className="relative z-20 overflow-hidden">
        ...
        <div className="container-app pt-0 pb-16 md:pb-24 w-full flex flex-col items-center text-center">
          <div className="max-w-4xl pt-12 md:pt-20">
            ...
            <h1
              className="font-display text-5xl sm:text-7xl md:text-8xl lg:text-9xl leading-[0.95] sm:leading-[0.92] mb-8 animate-fade-up tracking-tight"
              style={{ animationDelay: "80ms" }}
            >
              Suivez l'activité parlementaire,
              <br />
              <span className="text-gradient italic">
                maximisez la transparence.
              </span>
            </h1>

            <p
              className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-up"
              style={{ animationDelay: "160ms" }}
            >
              Obtenez les votes en temps réel, accédez aux analyses détaillées
              de la <strong className="text-foreground">17e législature</strong>{" "}
              — sans filtre politique. Plus de{" "}
            ...
            {/* SearchBar centrale */}
            <div
              className="animate-fade-up w-full max-w-2xl mx-auto"
          ...
          <div className="animate-fade-up">
            ...
            >
              <div
                ...
                style={{
                  background:
                    spotlight.sort && /adopt/i.test(spotlight.sort)
      ...
      {/* DERNIERS SCRUTINS */}
      <section className="container-app pb-16 pt-16 relative z-10">
...
function PartnersRow() {
  return (
    <div
      className="mt-20 md:mt-28 animate-fade-up w-full"
      style={{ animationDelay: "320ms" }}
    >
      <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60 mb-8 font-medium">
        Utilisé par des citoyens et organisations de confiance
      </p>
      <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8 grayscale opacity-40 hover:opacity-70 transition-opacity duration-500">
          ...
          {points.map(({ Icon, title, desc }, i) => (
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.55 0.22 300 / 14%), oklch(0.45 0.25 280 / 22%))",
  ...
  if (!src || err)
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.55 0.22 300 / 15%), oklch(0.45 0.25 280 / 20%))",
          color: "oklch(0.55 0.22 300)",
        }}
        aria-hidden="true"
      >

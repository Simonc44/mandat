    ...
    <div className="page-enter">
      <section className="hero-attach relative">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.70 0.18 285 / 55%), transparent 70%)",
          }}
          aria-hidden="true"
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.72 0.14 305 / 45%), transparent 70%)",
            animationDelay: "-5s",
          }}
          aria-hidden="true"
        />
        ...
        <div className="container-app relative z-10 pt-14 sm:pt-20 md:pt-24 pb-56 sm:pb-72 md:pb-80 text-center">
          ...
          <div
            className="mt-16 sm:mt-20 animate-fade-up"
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground mb-1">
                  ...
                  <span
                    ...
                    style={{
                      color: /adopt/i.test(spotlight.sort)
                        ? "var(--color-pour)"
                        : "var(--color-contre)",
                ...
                <p className="text-foreground font-medium leading-snug group-hover:text-primary transition-colors duration-200 line-clamp-2">
                  {spotlight.titre
                    ? spotlight.titre.charAt(0).toUpperCase() +
                      spotlight.titre.slice(1)
                    : `Scrutin n°${spotlight.numero}`}
                </p>
                {(() => {
                  const p = parseInt(spotlight.nombre_pours) || 0,
                    c = parseInt(spotlight.nombre_contres) || 0,
                    a = parseInt(spotlight.nombre_abstentions) || 0;
      ...
      <StoryReveal
        as="section"
        className="container-app pb-16 pt-4 relative z-10 -mt-4"
      >
...
function StripeIcon() {
  return (
    ...
    >
      ...
      <path
        d="M20.5 12.5c0-1.5-1.2-2.5-3.5-2.5-2.8 0-4 1.4-4 2.8 0 1.9 1.8 2.7 3.5 3.2 1.4.4 2.5.9 2.5 2 0 1.2-1.1 1.8-2.8 1.8-1.8 0-2.9-.7-3.2-1.8"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
      />
      ...
      <div className="container-app">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              Notre plateforme regroupe l'intégralité des{" "}
              <strong>scrutins publics</strong> de la 17e législature. Vous
              pouvez rechercher un élu par son nom, sa circonscription ou son
              groupe politique pour voir l'historique complet de ses votes :
              pour, contre, ou abstention.
            </p>
            <p>
              Nous utilisons les données officielles en temps réel pour vous
              garantir une transparence totale. Que ce soit pour un projet de
              loi sur la justice, l'économie ou l'environnement, vous disposez
              enfin d'un outil clair pour comprendre qui vote quoi, et pourquoi.
            </p>
          </div>
          <div className="card-glass rounded-[2rem] p-8 border border-white/20 shadow-2xl">
            <h3 className="font-display text-2xl text-foreground mb-4">
              Les étapes pour s'informer :
            </h3>
            <ul className="space-y-4">
              <li className="flex gap-4">
                ...
                <p>
                  <strong className="text-foreground">Recherchez :</strong>{" "}
                  Utilisez la barre de recherche pour trouver un député ou un
              ...
              <li className="flex gap-4">
                ...
                <p>
                  <strong className="text-foreground">Analysez :</strong>{" "}
                  Consultez le détail des votes par groupe politique et les
                  résultats globaux du scrutin.
                </p>
              </li>
              <li className="flex gap-4">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold">
                ...
                <p>
                  <strong className="text-foreground">Partagez :</strong> Chaque
                  page est conçue pour être partagée facilement afin d'alimenter
                  le débat citoyen.
                </p>
              </li>
            </ul>
  ...
  return (
    <div ref={ref} className="relative" style={{ zIndex: 9999 }}>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          const s = sanitizeSearchInput(q.trim());
          if (s) {
            setOpen(false);
            nav({ to: "/recherche", search: { q: s } });
          }
        }}
        role="search"

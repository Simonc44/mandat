...
export function Header() {
  ...
  return (
    <>
      ...
      <header
        className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? "glass-navbar shadow-sm" : "glass-navbar border-b border-border/30"}`}
      >
...
export function CookieBanner() {
  ...
  useEffect(() => {
    if (!localStorage.getItem("mandat_cookie_consent")) setVisible(true);
  }, []);
    ...
    >
      <div className="glass-strong rounded-3xl p-5 space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
              ...
              ni tracker tiers. Seuls des cookies techniques essentiels sont
              déposés — aucun consentement supplémentaire n'est requis.
            </p>
          </div>
        </div>
        <div className="rounded-xl bg-muted/40 p-3 text-xs text-muted-foreground space-y-1">
          <div className="flex items-center gap-2">
            <span
              ...
              aria-hidden="true"
            />
            Cookies essentiels uniquement (thème, session)
          </div>
          <div className="flex items-center gap-2">
            <span
              ...
              aria-hidden="true"
            />
            Aucun cookie publicitaire · Aucun tracker
          </div>
        </div>
        <button
          onClick={dismiss}
        ...
        <p className="text-[10px] text-muted-foreground text-center">
          ...
          {" · "}
          <Link to="/a-propos" className="underline hover:text-primary">
            À propos du projet
          </Link>
        </p>
      </div>

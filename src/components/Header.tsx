...
// ═══════════════════════════════════════════════════════════
// COOKIE BANNER — reformulé, un seul bouton, sans ambiguïté
// ═══════════════════════════════════════════════════════════
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
              ...
              Seuls des cookies techniques essentiels (préférences de thème, session) sont déposés — aucun consentement supplémentaire n'est requis.
            </p>
          </div>
        </div>
